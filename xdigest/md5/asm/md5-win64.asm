...
global	xdig_md5_block_data_order

xdig_md5_block_data_order:
	mov	QWORD[8+rsp],rdi	;WIN64 prologue
	mov	QWORD[16+rsp],rsi
	mov	rax,rsp
$L$SEH_begin_xdig_md5_block_data_order:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
...
$L$SEH_end_xdig_md5_block_data_order:
...
ALIGN	4
	DD	$L$SEH_begin_xdig_md5_block_data_order wrt ..imagebase
	DD	$L$SEH_end_xdig_md5_block_data_order wrt ..imagebase
	DD	$L$SEH_info_xdig_md5_block_data_order wrt ..imagebase

section	.xdata rdata align=8
ALIGN	8
$L$SEH_info_xdig_md5_block_data_order:
DB	9,0,0,0
