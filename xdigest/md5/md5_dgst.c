/*
 * md5/md5_dgst.c: low-level implementation of MD5 algorithm
 *
 * ====================================================================
...
#  undef X
# endif
void md5_block_data_order(xdig_md5_ctx_t *c, const void *data_, size_t num)
{
...
#  define X(i)   XX##i
# else
    XDIG_MD5_LONG XX[XDIG_MD5_LBLOCK];
#  define X(i)   XX[i]
# endif
