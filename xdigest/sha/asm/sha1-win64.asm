...
global	xdig_sha1_block_data_order

ALIGN	16
xdig_sha1_block_data_order:
	mov	QWORD[8+rsp],rdi	;WIN64 prologue
	mov	QWORD[16+rsp],rsi
	mov	rax,rsp
$L$SEH_begin_xdig_sha1_block_data_order:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
...
$L$SEH_end_xdig_sha1_block_data_order:

ALIGN	32
xdig_sha1_block_data_order_shaext:
	mov	QWORD[8+rsp],rdi	;WIN64 prologue
	mov	QWORD[16+rsp],rsi
	mov	rax,rsp
$L$SEH_begin_xdig_sha1_block_data_order_shaext:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
...
$L$SEH_end_xdig_sha1_block_data_order_shaext:

ALIGN	16
xdig_sha1_block_data_order_ssse3:
	mov	QWORD[8+rsp],rdi	;WIN64 prologue
	mov	QWORD[16+rsp],rsi
	mov	rax,rsp
$L$SEH_begin_xdig_sha1_block_data_order_ssse3:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
...
$L$SEH_end_xdig_sha1_block_data_order_ssse3:

ALIGN	16
xdig_sha1_block_data_order_avx:
	mov	QWORD[8+rsp],rdi	;WIN64 prologue
	mov	QWORD[16+rsp],rsi
	mov	rax,rsp
$L$SEH_begin_xdig_sha1_block_data_order_avx:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
...
$L$SEH_end_xdig_sha1_block_data_order_avx:

ALIGN	16
xdig_sha1_block_data_order_avx2:
	mov	QWORD[8+rsp],rdi	;WIN64 prologue
	mov	QWORD[16+rsp],rsi
	mov	rax,rsp
$L$SEH_begin_xdig_sha1_block_data_order_avx2:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
...
$L$SEH_end_xdig_sha1_block_data_order_avx2:
...
ALIGN	4
	DD	$L$SEH_begin_xdig_sha1_block_data_order wrt ..imagebase
	DD	$L$SEH_end_xdig_sha1_block_data_order wrt ..imagebase
	DD	$L$SEH_info_xdig_sha1_block_data_order wrt ..imagebase
	DD	$L$SEH_begin_xdig_sha1_block_data_order_shaext wrt ..imagebase
	DD	$L$SEH_end_xdig_sha1_block_data_order_shaext wrt ..imagebase
	DD	$L$SEH_info_xdig_sha1_block_data_order_shaext wrt ..imagebase
	DD	$L$SEH_begin_xdig_sha1_block_data_order_ssse3 wrt ..imagebase
	DD	$L$SEH_end_xdig_sha1_block_data_order_ssse3 wrt ..imagebase
	DD	$L$SEH_info_xdig_sha1_block_data_order_ssse3 wrt ..imagebase
	DD	$L$SEH_begin_xdig_sha1_block_data_order_avx wrt ..imagebase
	DD	$L$SEH_end_xdig_sha1_block_data_order_avx wrt ..imagebase
	DD	$L$SEH_info_xdig_sha1_block_data_order_avx wrt ..imagebase
	DD	$L$SEH_begin_xdig_sha1_block_data_order_avx2 wrt ..imagebase
	DD	$L$SEH_end_xdig_sha1_block_data_order_avx2 wrt ..imagebase
	DD	$L$SEH_info_xdig_sha1_block_data_order_avx2 wrt ..imagebase
section	.xdata rdata align=8
ALIGN	8
$L$SEH_info_xdig_sha1_block_data_order:
DB	9,0,0,0
	DD	se_handler wrt ..imagebase
$L$SEH_info_xdig_sha1_block_data_order_shaext:
DB	9,0,0,0
	DD	shaext_handler wrt ..imagebase
$L$SEH_info_xdig_sha1_block_data_order_ssse3:
DB	9,0,0,0
	DD	ssse3_handler wrt ..imagebase
	DD	$L$prologue_ssse3 wrt ..imagebase,$L$epilogue_ssse3 wrt ..imagebase
$L$SEH_info_xdig_sha1_block_data_order_avx:
DB	9,0,0,0
	DD	ssse3_handler wrt ..imagebase
	DD	$L$prologue_avx wrt ..imagebase,$L$epilogue_avx wrt ..imagebase
$L$SEH_info_xdig_sha1_block_data_order_avx2:
DB	9,0,0,0
	DD	ssse3_handler wrt ..imagebase
