/*
 * sha/sha_local.h: low-level implementation of SHA1 algorithm
 *
 * ====================================================================
...
#define HASH_CTX                xdig_sha1_ctx_t
...
# if !defined(SHA1_ASM)
static void HASH_BLOCK_DATA_ORDER(xdig_sha1_ctx_t *c, const void *p, size_t num)
{
